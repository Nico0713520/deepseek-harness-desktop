...
import { CURATED_INDUSTRY_ABILITIES } from './curated-industry-catalog.ts'
import {
...
const CURATED_INDUSTRY_OVERRIDES: Readonly<Record<string, readonly IndustryId[]>> = {
...
const RAW_ABILITIES: readonly AbilityDefinition[] = [
  ability({
    id: 'obra-superpowers',
...
export const ABILITIES: readonly AbilityDefinition[] = RAW_ABILITIES
